...
Контракт HTTP CRUD: SSOT `docs/rag/testing/crud-http.md` → диета `rag/crud-http.md`. Поверхность ярусов: `coverage-access` + `docs/coverage-profile.md`. Generic skills (`qa-write-test`) таблицу глаголов не держат.
